  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-4">
      <div className="text-center max-w-6xl mx-auto">
        ...
        {/* Subheading */}
        <p className="text-xl md:text-2xl text-white/80 mb-8 max-w-4xl mx-auto leading-relaxed animate-fade-in" style={{animationDelay: '0.2s'}}>
        ...
        {/* Stats */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-16 max-w-4xl mx-auto animate-fade-in" style={{animationDelay: '0.8s'}}>
